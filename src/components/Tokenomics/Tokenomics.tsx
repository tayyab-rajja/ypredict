    ...
    <section className="main-container">
      ...
      <div className="div w-full bg-[#161a25] rounded-xl min-h-[190px]">
        <div className="meettheteam-image-section">
            ...
            <div className="token-sale-table-container">
              <div className="token-sale-table">
                ...
                {allocVestingData.map((data, key) =>
                  <div key={`alloc-data-${key}`} className="token-sale-table-row table-row">
                    {/* <div className="row-image">
                      <img src="img/private-sale-row-image.svg" className="token-sale-row-image" alt="private-sale-row-image.svg" />
                    </div> */}
                    <div className="header-text">{data.allocatedTo}</div>
                    <div className="header-text withbgpad">{data.percent}</div>
                    <div className="header-text withbgpad">{data.supply}</div>
                    <div className="header-text withbgpad">{data.vesting}</div>
                  </div>
                )}
          ...
          <div className="token-sale-section road-map team-member-hidden">
            <div className="platform-payment">
              <div >
                <div className="payment-payment-title">
                  <span className="payment-yread">Build</span>
                </div>
                <div className="payment-payment-sub-title">Project is currently in development where tean is dedicated to have initial beta ready by Q1 2023. Including yPredict Predictions, yPredict Analytics, yPredict Terminal. This phase also includes token development & sales, listing, promotions.</div>
              </div>
            ...
            <div className="platform-payment">
              <div >
                <div className="payment-payment-title">
                  <span className="payment-yread">Grow</span>
                </div>
                <div className="payment-payment-sub-title">Growth phase will focus mainly on stabilizing the core offerings and organically growing the community and reaching a 100m marketcap for YPRED tokens. </div>
              </div>
              {/* <div className="platform-payment-image">
            ...
            <div className="platform-payment">
              <div >
                <div className="payment-payment-title">
                  <span className="payment-yread">Engage & Scale</span>
                </div>
                <div className="payment-payment-sub-title">By this phase we expect to have our ecosystem fully developed and stable products and growing community. This phase will focus on large scale marketing campaigns to reach over 1m active users on all our platforms combined. </div>
              </div>
              {/* <div className="platform-payment-image">
